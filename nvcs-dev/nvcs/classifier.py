...
@author: knimerfro
'''
# modified Apr 14,2022, ctoney

class Node:
    def __init__(self, ident, parent, config, description):
        self.ident = ident
        self.parent = parent
        self.level = config[0] # NVCS level
        self.code = config[1] # NVCS code
        self.match_function = config[2]
