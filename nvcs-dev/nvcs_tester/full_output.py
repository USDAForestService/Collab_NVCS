    ...
    for inventory_year in out_Options["inventory_years"]:
        ...
        if type == "west":
            python_key_input_vw_definition = (
                ...
                "SPECIES, RIV, WETLAND, "
                "(CASE WHEN LOWER(RUDERAL)='yes' OR LOWER(RUDERAL)='y' THEN 'yes' WHEN LOWER(RUDERAL)='no' OR LOWER(RUDERAL)='n' THEN 'no' ELSE RUDERAL END) 'RUDERAL', "
                "(CASE WHEN LOWER(EXOTIC)='yes' OR LOWER(EXOTIC)='y' THEN 'yes' WHEN LOWER(EXOTIC)='no' OR LOWER(EXOTIC)='n' THEN 'no' ELSE EXOTIC END) 'EXOTIC', "
